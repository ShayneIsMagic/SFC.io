...
function fixProcessStepColors() {
  const processSteps = document.querySelectorAll(
    ".process-step, .process-section .process-step"
  );
...
function fixCardColors() {
  const cards = document.querySelectorAll(
    ".benefit-item, .service-item, .testimonial-card, .leader-card, .why-card"
  );
  cards.forEach((card) => {
    // Skip if part of navbar
...
function loadSearchData() {
  ...
  searchData = [
    // Home page content
    {
      ...
      content:
        "Comprehensive Salesforce implementation and adoption services for businesses and nonprofits",
      url: "index.html",
      category: "Services",
    ...
    },
    {
      ...
      content:
        "Custom Salesforce development solutions tailored to your specific business needs",
    ...
    },
    {
      ...
      content:
        "Salesforce training programs and certification preparation for your team",
      url: "index.html#services",
      category: "Services",
    ...
    },
    {
      ...
      content:
        "Seamless Salesforce integrations with your existing systems and applications",
      url: "index.html#services",
      category: "Services",
    ...
    },
    {
      ...
      content:
        "Advanced Salesforce automation solutions to streamline your business processes",
      url: "index.html#services",
      category: "Services",
    ...
    },
    {
      ...
      content:
        "Expert Salesforce migration services to upgrade and optimize your platform",
      url: "index.html#services",
      category: "Services",
    ...
    // Services page content
    {
      ...
      content:
        "Complete Salesforce implementation and adoption services with proven methodologies",
      url: "services.html",
      category: "Services",
    ...
    },
    {
      title: "Custom Salesforce Development",
      content:
        "Custom Salesforce development with advanced features and integrations",
      url: "services.html",
      category: "Services",
    ...
    },
    {
      ...
      content:
        "Comprehensive Salesforce training programs for administrators and users",
      url: "services.html",
      category: "Services",
    ...
    },
    {
      ...
      content:
        "Seamless Salesforce system integration with third-party applications",
      url: "services.html",
      category: "Services",
    ...
    },
    {
      ...
      content:
        "Advanced Salesforce AI and automation solutions for business efficiency",
      url: "services.html",
      category: "Services",
    ...
    },
    {
      ...
      content:
        "Expert Salesforce migration services for platform upgrades and optimization",
      url: "services.html",
      category: "Services",
    ...
    // Success Stories content
    {
      ...
      content:
        "How we transformed LA Chamber with comprehensive Salesforce solutions and training",
    ...
    },
    {
      ...
      content:
        "Nonprofit Salesforce implementation that increased donor retention by 35%",
      url: "success-stories.html",
      category: "Success Stories",
    ...
    // Expertise content
    {
      ...
      content:
        "Specialized Salesforce solutions for nonprofit organizations and NPSP",
      url: "expertise.html",
      category: "Expertise",
    ...
    },
    {
      ...
      content:
        "15+ Salesforce certifications across all major Salesforce products",
      url: "expertise.html",
      category: "Expertise",
    ...
    // Implementation Recovery content
    {
      ...
      content:
        "Expert Salesforce implementation recovery services for failed or stalled projects",
    ...
    // Partner content
    {
      ...
      content:
        "Our partners and clients across various industries trust us with their Salesforce transformation",
    ...
    },
    {
      ...
      content:
        "Organizations that trust us with their Salesforce transformation and implementation",
      url: "clients.html",
      category: "Partners",
    ...
    },
    {
      ...
      content:
        "Strategic Salesforce consulting partnerships that deliver results and build long-term relationships",
      url: "clients.html",
      category: "Partners",
    ...
    },
    {
      ...
      content:
        "See our partner logos and read testimonials from organizations we've helped transform",
      url: "clients.html",
      category: "Partners",
    ...
    },
    {
      ...
      content:
        "A DevPipeline Division - This partnership allows us to provide comprehensive Salesforce solutions",
      url: "index.html",
      category: "Partners",
    ...
    },
    {
      ...
      content:
        "Professional Salesforce implementation partner services for businesses and nonprofits",
      url: "services.html",
      category: "Services",
    ...
    },
    {
      ...
      content:
        "Multi-departmental Salesforce solutions for Chambers of Commerce and business associations",
      url: "services.html",
      category: "Services",
    ...
    // Nonprofit content
    {
      ...
      content:
        "Specialized Salesforce Nonprofit Cloud and NPSP solutions for mission-driven organizations",
      url: "services.html",
      category: "Services",
    ...
    // Client content
    {
      ...
      content:
        "Real results from real organizations. See how our Salesforce consulting services have transformed businesses and nonprofits",
      url: "success-stories.html",
      category: "Success Stories",
    ...
    },
    {
      ...
      content:
        "Hear from our satisfied clients about their Salesforce transformation and success",
      url: "expertise.html",
      category: "Expertise",
    ...
    },
    {
      ...
      content:
        "100% client satisfaction rate with proven results across all implementations",
      url: "success-stories.html",
      category: "Success Stories",
    ...
    // ROI content
    {
      ...
      content:
        "Calculate your Salesforce ROI with our proven methodologies that deliver measurable ROI for businesses and nonprofits",
      url: "index.html",
      category: "Services",
    ...
    },
    {
      ...
      content:
        "Return on investment achieved within 6 months of Salesforce implementation",
      url: "success-stories.html",
      category: "Success Stories",
    ...
    // Training content
    {
      title: "Salesforce Training Programs",
      content:
        "Comprehensive Salesforce training programs for administrators and end users with certification preparation",
    ...
    },
    {
      ...
      content:
        "Expert-led Salesforce administrator training with certification preparation and ongoing support",
      url: "clients.html",
      category: "Services",
    ...
    },
    {
      ...
      content:
        "Comprehensive user training and change management support for successful Salesforce adoption",
      url: "index.html",
      category: "Services",
    ...
    // Certification content
    {
      ...
      content:
        "Our team holds 15+ Salesforce certifications across all major Salesforce products and clouds",
      url: "expertise.html",
      category: "Expertise",
    ...
    },
    {
      ...
      content:
        "Salesforce certification preparation and training for administrators and developers",
      url: "services.html",
      category: "Services",
  ...
  console.log(
    "Search data loaded successfully. Total items:",
    searchData.length
  );
...
function initializeAnimations() {
  const animatedElements = document.querySelectorAll(
    ".service-card, .feature-card, .cert-category, .testimonial"
  );
...
// Form Validation
export function validateForm(form = null) {
  ...
  // Email validation
  const emailField = scope.getElementById("email");
